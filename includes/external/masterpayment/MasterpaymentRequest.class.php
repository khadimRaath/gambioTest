...
class MasterpaymentRequest extends MasterpaymentActions 
{
	...
	*/
	function prepareParams() 
	{
		...
		$params['UrlPatternSuccess'] = $this->getShopURL() . 'callback/masterpayment/masterpayment_gm_callback.php';
		$params['UrlPatternFailure'] = $this->getShopURL() . 'callback/masterpayment/masterpayment_gm_callback.php';
