...
/* -----------------------------------------------------------------------------------------
  ...
  class ups_ORIGIN {
    ...
    public function __construct() {
      ...
      $this->free = sprintf(MODULE_SHIPPING_UPS_TEXT_FREE, MODULE_SHIPPING_UPS_FREEAMOUNT);
...
function quote($method = '') {
	...
	if ($freeship == true) {
		$this->quotes = array('id' => $this->code,
			...
			'title' => $shipping_method . ' (' . $shipping_num_boxes . ' x ' . $shipping_weight . ' ' . MODULE_SHIPPING_UPS_TEXT_UNITS .')<br>' . sprintf(MODULE_SHIPPING_UPS_TEXT_FREE, MODULE_SHIPPING_UPS_FREEAMOUNT),
			'cost' => $shipping_cost * $shipping_num_boxes,)));
	} elseif ($lowship == true) {
		$this->quotes = array('id' => $this->code,
			'module' => MODULE_SHIPPING_UPS_TEXT_TITLE,
			'methods' => array(array('id' => $this->code,
			'title' => $shipping_method . ' (' . $shipping_num_boxes . ' x ' . $shipping_weight . ' ' . MODULE_SHIPPING_UPS_TEXT_UNITS .')<br>' . sprintf(MODULE_SHIPPING_UPS_TEXT_LOW, MODULE_SHIPPING_UPS_FREEAMOUNT),
			'cost' => $shipping_cost * $shipping_num_boxes,)));
	} else {
		$this->quotes = array('id' => $this->code,
			'module' => MODULE_SHIPPING_UPS_TEXT_TITLE,
	...
	if ($error == true) $this->quotes['error'] = MODULE_SHIPPING_UPS_UNDEFINED_RATE;
