<?php
/* -----------------------------------------------------------------------------------------
   $Id: postfinanceag_diners.php, v.2.1 swisswebXperts GmbH
...
class postfinanceag_diners_ORIGIN extends postfinance
{
    var $title, $description, $enabled, $orderid, $productive;

    public function __construct()
    {
        $this->code = 'postfinanceag_diners';
        $this->images = array('diners');

        $this->paymentMethod = 'CreditCard';
        $this->paymentBrand  = 'Diners Club';
...
MainFactory::load_origin_class('postfinanceag_diners');