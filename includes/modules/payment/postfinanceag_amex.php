<?php
/* -----------------------------------------------------------------------------------------
   $Id: postfinanceag_amex.php, v.2.1 swisswebXperts GmbH
...
class postfinanceag_amex_ORIGIN extends postfinance
{
    var $title, $description, $enabled, $orderid, $productive;

    public function __construct()
    {
        $this->code = 'postfinanceag_amex';
        $this->images = array('amex');

        $this->paymentMethod = 'CreditCard';
        $this->paymentBrand  = 'American Express';
...
MainFactory::load_origin_class('postfinanceag_amex');