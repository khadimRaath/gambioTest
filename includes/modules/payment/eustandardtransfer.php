<?php
/* --------------------------------------------------------------
   eustandardtransfer.php 2014-07-15 mb
   Gambio GmbH
   http://www.gambio.de
...
class eustandardtransfer_ORIGIN {
	...
	public function __construct() {
		...
		$this->description = sprintf(MODULE_PAYMENT_EUTRANSFER_TEXT_DESCRIPTION, MODULE_PAYMENT_EUTRANSFER_BANKNAM, MODULE_PAYMENT_EUTRANSFER_BRANCH, MODULE_PAYMENT_EUTRANSFER_ACCNAM, MODULE_PAYMENT_EUTRANSFER_ACCNUM, MODULE_PAYMENT_EUTRANSFER_ACCIBAN, MODULE_PAYMENT_EUTRANSFER_BANKBIC);
	...
	function confirmation() {
		...
		$confirmation = array ('title' => $this->title.': '.$this->check, 'fields' => array (array ('title' => $this->description)), 'description' => $this->info);
