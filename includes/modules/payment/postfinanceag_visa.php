<?php
/* -----------------------------------------------------------------------------------------
   $Id: postfinanceag_visa.php, v.2.1 swisswebXperts GmbH
...
class postfinanceag_visa_ORIGIN extends postfinance
{
    var $title, $description, $enabled, $orderid, $productive;

    public function __construct()
    {
        $this->code = 'postfinanceag_visa';
        $this->images = array('visa');
...
MainFactory::load_origin_class('postfinanceag_visa');