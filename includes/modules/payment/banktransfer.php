<?php
/* --------------------------------------------------------------
  banktransfer.php 2014-07-15 gm
  Gambio GmbH
  http://www.gambio.de
...
class banktransfer_ORIGIN
{
	...
	public function __construct()
	{
		...
		{
			$this->email_footer = MODULE_PAYMENT_BANKTRANSFER_TEXT_EMAIL_FOOTER . HTTP_SERVER . DIR_WS_CATALOG . MODULE_PAYMENT_BANKTRANSFER_URL_NOTE ;
		}
	}
	...
	function pre_confirmation_check()
	{
		...
		if(isset($banktransfer_result) == false)
		{
			$banktransfer_result = 2;
		}
	...
	function install()
	{
		...
		xtc_db_query("insert into " . TABLE_CONFIGURATION . " ( configuration_key, configuration_value, configuration_group_id, sort_order, set_function, date_added) values ('MODULE_PAYMENT_BANKTRANSFER_DATABASE_BLZ', 'true', '6', '0', 'gm_cfg_select_option(array(\'true\', \'false\'), ', now())");
		...
		xtc_db_query("insert into " . TABLE_CONFIGURATION . " ( configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES('MODULE_PAYMENT_BANKTRANSFER_DATACHECK', 'true', 6, 3, NULL, '2011-05-19 08:19:02', NULL, 'gm_cfg_select_option(array(''true'', ''false''), ')");
	}
	...
	function keys()
	{
		return array('MODULE_PAYMENT_BANKTRANSFER_STATUS',
					...
					'MODULE_PAYMENT_BANKTRANSFER_DATACHECK',
