...
/* --------------------------------------------------------------
   ...
   (c) 2003 XT-Commerce - community made shopping http://www.xt-commerce.com ($Id: language.php 962 2005-05-27 17:27:01Z mz $)
  ...
  class language_ORIGIN {
    ...
    public function __construct($lng = '') {
      ...
      if ( (!empty($lng)) && (isset($this->catalog_languages[$lng])) && $this->catalog_languages[$lng]['status'] == 1 ) {
