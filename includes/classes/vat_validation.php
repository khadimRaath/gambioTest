...
class vat_validation_ORIGIN {
	...
	function checkVatID_EU($vat_id, $country_id) {
		...
		{
			LogControl::get_instance()->error('Connection to http://ec.europa.eu/ could not be established.', 'widgets', 'vat_validation_errors', 'error', 'USER ERROR', 0, print_r($coo_soap_client->getError(), true));
		}
		else
		{
