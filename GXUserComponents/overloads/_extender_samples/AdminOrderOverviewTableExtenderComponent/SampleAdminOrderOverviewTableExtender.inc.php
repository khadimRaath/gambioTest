<?php
/* --------------------------------------------------------------
   SampleAdminOrderOverviewTableExtender.inc.php 2016-03-10
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class SampleAdminOrderOverviewTableExtender
 *
 * This is a sample overload for the AdminOrderOverviewTableExtenderComponent.
 * 
 * @see AdminOrderOverviewTableExtenderComponent
 */
class SampleAdminOrderOverviewTableExtender extends SampleAdminOrderOverviewTableExtender_parent
{
	/**
	...
	{
		$content = 'Beispieldaten ' . $this->orderId;
