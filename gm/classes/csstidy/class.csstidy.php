<?php
/* --------------------------------------------------------------
   class.csstidy.php 2013-03-25 gm
   Gambio GmbH
   http://www.gambio.de
...
{
	function ctype_space($p_string)
	{
		$t_found_only_spaces = true;
		
		if(trim($p_string) !== '') 
		{
			$t_found_only_spaces = false;
		}
		
		return $t_found_only_spaces;
	}
}	
// EOF GM_MOD		
 ...
 * @version 1.11
 */
static function is_token(&$string, $i)
{
	$tokens =& $GLOBALS['csstidy']['tokens'];
