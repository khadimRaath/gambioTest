...
if (isset($_GET['action']) && ($_GET["action"] === "save")) {
    try {
        ...
        $sgEmptySettings = array(
            'language', 'currency', 'country', 'tax_zone_id', 'order_status_open', 'order_status_shipping_blocked', 
...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
    ...
    <div id="shopgate_image_wiki">
        <a target="_blank" href="<?php echo SHOPGATE_LINK_WIKI; ?>">
            <img src="../shopgate/gambiogx/admin/includes/img/shopgate_manual_logo.jpg" alt="Shopgate Wiki"/>
        </a>
    </div>
...
elseif ($_GET["sg_option"] === "config"): ?>
    ...
    <?php if (count($sgLanguages) > 1): ?>
        <?php if ($sg_language === null): ?>
            <?php if (!empty($shopgate_info)): ?>
                <div class="shopgate_blue_message"><strong
                        style="color: blue;">Info:</strong> <?php echo $shopgate_info; ?></div>
                <br/>
            <?php endif; ?>
        ...
        <div class="shopgate_language_selection" id="shopgate_language_selection"
             style="display: <?php echo ($sg_language !== null) ? 'block' : 'none' ?>">
            ...
            <select onchange="sgLoadLanguage('<?php echo $_GET["sg_option"] ?>')" id="sg_language">
                ...
                <?php foreach ($sgLanguages as $sgLanguage): ?>
                    <option
                        value="<?php echo $sgLanguage['code']; ?>"<?php if ($sgLanguage['code'] == $sg_language) {echo ' selected="selected"';} ?>>
        ...
        <?php if ($sg_language !== null): ?>
            ...
            <input type="checkbox" name="sg_global_switch" value="1" onclick="sgToggleSettings(this)"
                   id="sg_global_switch" <?php if (!empty($sgUseGlobalConfig)) echo 'checked="checked"' ?> />
    ...
    <tr>
        <th colspan="2" style="text-align: left;"><?php echo SHOPGATE_CONFIG_CONNECTION_SETTINGS; ?></th>
    </tr>
    <tr>
                ...
                <tr>
                    ...
                    <td class="<?php echo $tableClass; ?> shopgate_input<?php echo empty($error['customer_number']) ? '' : ' error' ?>">
                        <div><input type="text" name="_shopgate_config[customer_number]"
                                    value="<?php echo $shopgateConfig["customer_number"] ?>"/></div>
    ...
    <tr>
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    <td width="300" class="<?php echo $tableClass; ?>"><label><?php echo SHOPGATE_CONFIG_SHOP_NUMBER; ?></label>
                    </td>
                    <td class="<?php echo $tableClass; ?> shopgate_input<?php echo empty($error['shop_number']) ? '' : ' error' ?>">
                        <div><input type="text" name="_shopgate_config[shop_number]"
                                    value="<?php echo $shopgateConfig["shop_number"] ?>"/></div>
    ...
    <tr>
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    <td width="300" class="<?php echo $tableClass; ?>"><label><?php echo SHOPGATE_CONFIG_APIKEY; ?></label></td>
    ...
    <tr>
        <th colspan="2" style="text-align: left;"><?php echo SHOPGATE_CONFIG_MOBILE_REDIRECT_SETTINGS; ?></th>
    </tr>
    <tr>
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    <td width="300" class="<?php echo $tableClass; ?>"><label><?php echo SHOPGATE_CONFIG_MODULE_ACTIVE; ?></label></td>
                    <td class="<?php echo $tableClass; ?> shopgate_input">
                        <div>
                            <input
                                type="radio" <?php echo MODULE_PAYMENT_SHOPGATE_STATUS == 'True' ? 'checked=""' : '' ?>
                                value="True" name="_shopgate_config[module_active]" id="sg_module_active_on">
                            <label for="sg_module_active_on"><?php echo SHOPGATE_CONFIG_MODULE_ACTIVE_ON; ?></label><br>
                            <input
                                type="radio" <?php echo MODULE_PAYMENT_SHOPGATE_STATUS == 'False' ? 'checked=""' : '' ?>
                                value="False" name="_shopgate_config[module_active]" id="sg_module_active_off">
    ...
    <tr>
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    <td width="300" class="<?php echo $tableClass; ?>"><label><?php echo SHOPGATE_CONFIG_ALIAS; ?></label></td>
    ...
    <tr>
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    <td width="300" class="<?php echo $tableClass; ?>"><label><?php echo SHOPGATE_CONFIG_CNAME; ?></label></td>
        ...
        <tr>
            <td class="shopgate_setting" align="right">
                <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                    <tr>
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <label><?php echo SHOPGATE_CONFIG_REDIRECT_LANGUAGES; ?></label></td>
    ...
    <tr>
        <th colspan="2" style="text-align: left;"><?php echo SHOPGATE_CONFIG_EXPORT_SETTINGS; ?></th>
    </tr>
    <?php if ($sg_language === null): ?>
        <tr>
            <td class="shopgate_setting" align="right">
                        ...
                        <div>
                            <select name="_shopgate_config[country]">
                                ...
                                <?php foreach ($sgCountries as $sgCountry): ?>
                                    <option
                                        value="<?php echo $sgCountry["countries_iso_code_2"] ?>" <?php echo $shopgateConfig["country"] == $sgCountry["countries_iso_code_2"] ? 'selected="selected"' : '' ?>>
                        ...
                        <div>
                            <select name="_shopgate_config[tax_zone_id]">
                                ...
                                <?php foreach ($sgTaxZones as $sgTaxZone): ?>
                                    <option
                                        value="<?php echo $sgTaxZone["geo_zone_id"] ?>" <?php echo $shopgateConfig["tax_zone_id"] == $sgTaxZone["geo_zone_id"] ? 'selected=""' : '' ?>>
    ...
    <tr>
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    <td width="300" class="<?php echo $tableClass; ?>">
                        <label><?php echo SHOPGATE_CONFIG_EXTENDED_REVERSE_CATEGORIES_SORT_ORDER; ?></label></td>
                    <td class="<?php echo $tableClass; ?> shopgate_input">
                        <div>
                            <input
                                type="radio" <?php echo $shopgateConfig["reverse_categories_sort_order"] ? 'checked=""' : '' ?>
                                value="1" name="_shopgate_config[reverse_categories_sort_order]" id="sg_reverse_categories_sort_order_on">
                            ...
                            <input
                                type="radio" <?php echo !$shopgateConfig["reverse_categories_sort_order"] ? 'checked=""' : '' ?>
                                value="0" name="_shopgate_config[reverse_categories_sort_order]" id="sg_reverse_categories_sort_order_off">
    ...
    <tr>
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    <td width="300" class="<?php echo $tableClass; ?>">
                        <label><?php echo SHOPGATE_CONFIG_EXTENDED_REVERSE_ITEMS_SORT_ORDER; ?></label></td>
                    <td class="<?php echo $tableClass; ?> shopgate_input">
                        <div>
                            <input
                                type="radio" <?php echo $shopgateConfig["reverse_items_sort_order"] ? 'checked=""' : '' ?>
                                value="1" name="_shopgate_config[reverse_items_sort_order]" id="sg_reverse_items_sort_order_on">
                            <label for="sg_reverse_items_sort_order_on"><?php echo SHOPGATE_CONFIG_EXTENDED_REVERSE_ITEMS_SORT_ORDER_ON; ?></label><br>
                            <input
                                type="radio" <?php echo !$shopgateConfig["reverse_items_sort_order"] ? 'checked=""' : '' ?>
                                value="0" name="_shopgate_config[reverse_items_sort_order]" id="sg_reverse_items_sort_order_off">
    ...
    <tr>
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    <td width="300" class="<?php echo $tableClass; ?>">
                        <label><?php echo SHOPGATE_CONFIG_EXTENDED_PRODUCTSDESCRIPTION; ?></label></td>
                    <td class="<?php echo $tableClass; ?> shopgate_input">
                        <div>
        ...
        <tr>
            <td class="shopgate_setting" align="right">
                <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                    <tr>
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <label><?php echo SHOPGATE_CONFIG_EXTENDED_VARIATION_TYPE; ?></label></td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                                <select name="_shopgate_config[variation_type]">
                                    <?php foreach ($sgVariationTypes as $sgVariationType => $sgVariationTypeName): ?>
                                        <option value="<?php echo $sgVariationType ?>"
                                            <?php echo $shopgateConfig["variation_type"] == $sgVariationType ? 'selected=""' : '' ?>>
    ...
    <tr>
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    <td width="300" class="<?php echo $tableClass; ?>">
                        <label><?php echo SHOPGATE_CONFIG_EXTENDED_EXPORT_PRICE_ON_REQUEST_PRODUCTS; ?></label></td>
                    <td class="<?php echo $tableClass; ?> shopgate_input">
                        <div>
                            <input
                                type="radio" <?php echo $shopgateConfig["export_price_on_request"] ? 'checked=""' : '' ?>
                                value="1" name="_shopgate_config[export_price_on_request]" id="sg_export_price_on_request_products_with_price">
                            ...
                            <input
                                type="radio" <?php echo !$shopgateConfig["export_price_on_request"] ? 'checked=""' : '' ?>
                                value="0" name="_shopgate_config[export_price_on_request]" id="sg_export_price_on_request_products_without_price">
    ...
    <tr>
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    <td width="300" class="<?php echo $tableClass; ?>">
                        <label><?php echo SHOPGATE_CONFIG_EXTENDED_EXPORT_PRODUCTS_CONTENT_MANAGED_FILES; ?></label></td>
                    <td class="<?php echo $tableClass; ?> shopgate_input">
                        <div>
                            <input
                                type="radio" <?php echo $shopgateConfig["export_products_content_managed_files"] ? 'checked=""' : '' ?>
                                value="1" name="_shopgate_config[export_products_content_managed_files]"
                            ...
                            <input
                                type="radio" <?php echo !$shopgateConfig["export_products_content_managed_files"] ? 'checked=""' : '' ?>
                                value="0" name="_shopgate_config[export_products_content_managed_files]"
        ...
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    ...
                    <td class="<?php echo $tableClass; ?> shopgate_input">
                        <div>
                            <input type="text" value="<?php echo $shopgateConfig["max_attributes"] ?>"
                                   name="_shopgate_config[max_attributes]" id="sg_max_attributes">
                            <br>
                        </div>
        ...
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    ...
                    <td class="<?php echo $tableClass; ?> shopgate_input">
                        <div>
                            <?php $inputSize = (count($sgProductFilters) <= 10) ? count($sgProductFilters) : 10 ?>
                            <select multiple="multiple" name="_shopgate_config[export_filters_as_properties][]" id="sg_export_filters_as_properties" size="<?php echo $inputSize ?>">
                                <?php foreach($sgProductFilters as $filter): ?>
                                    <?php $selected = (in_array($filter['feature_name'], $shopgateConfig["export_filters_as_properties"])) ? 'selected="selected"' : '' ?>
    ...
    <tr>
        <th colspan="2" style="text-align: left;"><?php echo SHOPGATE_CONFIG_ORDER_IMPORT_SETTINGS; ?></th>
    </tr>
    <tr>
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
        ...
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    ...
                    <td class="<?php echo $tableClass; ?> shopgate_input">
                        <div>
                            <select name="_shopgate_config[order_status_open]" id="sg_order_status_open">
        ...
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    ...
                    <td class="<?php echo $tableClass; ?> shopgate_input">
                        <div>
                            <select name="_shopgate_config[order_status_shipping_blocked]" id="sg_order_status_shipping_blocked">
        ...
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    ...
                    <td class="<?php echo $tableClass; ?> shopgate_input">
                        <div>
                            <select name="_shopgate_config[order_status_shipped]" id="sg_order_status_shipped">
        ...
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                <tr>
                    ...
                    <td class="<?php echo $tableClass; ?> shopgate_input">
                        <div>
                            <select name="_shopgate_config[order_status_canceled]" id="sg_order_status_canceled">
                                <?php if (!in_array($shopgateConfig['order_status_canceled'], array_keys($sgOrderStates))): ?>
                                    <option value="-"></option>
                                <?php endif; ?>
                                <option
    ...
    <tr>
        <th colspan="2" style="text-align: left;"><?php echo SHOPGATE_CONFIG_SYSTEM_SETTINGS; ?></th>
    </tr>
    <tr>
        <td class="shopgate_setting" align="right">
            <table cellspacing="0" cellpadding="4" border="0" class="shopgate_setting">
                    ...
                    <td class="<?php echo $tableClass; ?> shopgate_input<?php echo empty($error['api_url']) ? '' : ' error' ?>">
                        <div>
                            <select name="_shopgate_config[server]" id="sg_server">
                                <option
                                    value="live" <?php echo $shopgateConfig["server"] == 'live' ? 'selected=""' : '' ?>>
                                ...
                                <option
                                    value="custom" <?php echo $shopgateConfig["server"] == 'custom' ? 'selected=""' : '' ?>>
    ...
    <div class="sg_submit"><input type="submit" value="<?php echo SHOPGATE_CONFIG_SAVE; ?>" onclick="this.blur();"
                                  class="button"></div>
    </form>
<?php endif; ?>
                    </td>
