...
define('SHOPGATE_CONFIG_EXTENDED_ENCODING_DESCRIPTION', 'W&auml;hlen Sie das Encoding Ihres Shopsystems. &Uuml;blicherweise ist f&uuml;r GambioGX "ISO-8859-15" und ab GambioGX 2.1 "UTF-8" zu w&auml;hlen.');
...
define(
'SHOPGATE_CONFIG_VARIATION_TYPE_PRODUCTS_ATTRIBUTES', defined('BOX_PRODUCTS_ATTRIBUTES')
    ? BOX_PRODUCTS_ATTRIBUTES : 'Artikelattribute'
);
define(
'SHOPGATE_CONFIG_VARIATION_TYPE_PRODUCTS_PROPERTIES', defined('BOX_PROPERTIES') ? BOX_PROPERTIES
    : 'Artikeleigenschaften'
);
define('SHOPGATE_CONFIG_EXTENDED_VARIATION_TYPE', 'Variantenart');
define('SHOPGATE_CONFIG_EXTENDED_VARIATION_TYPE_DESCRIPTION', 'W&auml;hlen Sie die Variantenart f&uuml;r den Produktexport.<br/><b>Wichtig:</b> Ein Produkt darf nur eine Variante zur gleichen Zeit nutzen, sonst wird es nicht exportiert!');
...
define('SHOPGATE_CONFIG_EXTENDED_EXPORT_PRODUCTS_CONTENT_MANAGED_FILES_DESCRIPTION', 'W&auml;hlen Sie "Ja", wenn Sie m&ouml;chten, dass auch zum Produkt zugeh&ouml;rige Dateien und Links zu der Produktbeschreibung hinzugef&uuml;gt werden.');

define('SHOPGATE_PLUGIN_MAX_ATTRIBUTE_VALUE_HEADLINE', 'Anzahl der Attributoptionen');
define('SHOPGATE_PLUGIN_MAX_ATTRIBUTE_VALUE_DESCRIPTION', 'W&auml;hlen Sie hier die maximale Anzahl der Attribute aus. Sollte die angegebene Anzahl an Attributen &uuml;berschritten werden, so wird eine effizientere Datenstruktur zum Export der Produktdaten verwendet.(Standardwert: 50)');

define('SHOPGATE_CONFIG_EXPORT_OPTIONS_AS_INPUT_FIELD', 'Export von Produktoptionen als Eingabefeld');
define('SHOPGATE_CONFIG_EXPORT_OPTIONS_AS_INPUT_FIELD_DESCRIPTION', 'F&uuml;gen Sie die id (Kann unter "Artikelmerkmale" gefunden werden) der option(en), welche als Textfeld exportiert werden soll(en), der Textfl&auml;che hinzu.(Beispiel: 1,2,3).');

define('SHOPGATE_CONFIG_EXPORT_FILTERS_AS_PROPERTIES', 'Export von Artikel-Filtern als Eigenschaften');
define('SHOPGATE_CONFIG_EXPORT_FILTERS_AS_PROPERTIES_DESCRIPTION', 'Die ausgew&auml;lten Artikel-Filter werden als Eigenschaften exportiert.');
...
define('SHOPGATE_CONFIG_EXTENDED_STATUS_ORDER_SHIPPING_APPROVED_DESCRIPTION', 'W&auml;hlen Sie den Status f&uuml;r Bestellungen, deren Versand bei Shopgate nicht blockiert ist.');

define('SHOPGATE_CONFIG_EXTENDED_STATUS_ORDER_SHIPPING_BLOCKED', 'Versand blockiert');
define('SHOPGATE_CONFIG_EXTENDED_STATUS_ORDER_SHIPPING_BLOCKED_DESCRIPTION', 'W&auml;hlen Sie den Status f&uuml;r Bestellungen, deren Versand bei Shopgate blockiert ist.');
...
define('SHOPGATE_CONFIG_PAYMENT_NAME_MAPPING_LINK', 'https://support.shopgate.com/hc/de/articles/202798386-Anbindung-an-Gambio#4.3');
