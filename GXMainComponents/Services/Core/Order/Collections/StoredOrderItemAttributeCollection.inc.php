...
/* --------------------------------------------------------------
   StoredOrderItemAttributeCollection.inc.php 2015-10-27 gm
   Gambio GmbH
   http://www.gambio.de
...
MainFactory::load_class('OrderItemAttributeCollection');
 ...
 */
class StoredOrderItemAttributeCollection extends OrderItemAttributeCollection
{
	/**
