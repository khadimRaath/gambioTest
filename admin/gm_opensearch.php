...
/* 
	--------------------------------------------------------------
	gm_opensearch.php 2015-09-28 gm
	Gambio GmbH
	http://www.gambio.de
									...
									<table border="0" width="100%" cellspacing="0" cellpadding="0">
										<tr>
											<td width="120" class="dataTableHeadingContent">
												<?php 
													echo ($_GET['action'] !== 'gm_opensearch' && $_GET['action'] !== null)
														? '<a href="' . xtc_href_link('gm_opensearch.php', 'action=gm_opensearch') . '">' . TITLE_GM_OPENSEARCH . '</a>'
														: TITLE_GM_OPENSEARCH;
												?>
												</td>
											<td class="dataTableHeadingContent"  style="border-right: 0px;">
												<?php
													echo ($_GET['action'] !== 'gm_opensearch_conf')
															? '<a href="' . xtc_href_link('gm_opensearch.php', 'action=gm_opensearch_conf') . '">' . TITLE_GM_OPENSEARCH_CONF . '</a>'
															: TITLE_GM_OPENSEARCH_CONF;
													
												?>
											</td>
										</tr>
									</table>
									<div class="gx-container order-details breakpoint-small" id="gm_box_content" data-gx-widget="checkbox">
