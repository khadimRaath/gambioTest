<form class="grid hidden" data-gx-widget="checkbox" name="orders" action="<?php echo xtc_href_link(FILENAME_ORDERS, xtc_get_all_get_params(array('oID', 'action')) . '&action=deleteconfirm') ?>" method="post" id="multi_delete_confirm_form">

	<fieldset class="span12">
		<p class="modal-info-text"><?php echo TEXT_INFO_MULTI_DELETE_INTRO ?></p>

		<div class="control-group">
			<label for="parcel_services_dropdown"><?php echo TEXT_SELECTED_ORDERS ?></label>
