...
//Fonts
    public $use_ttf  = true;              // Use True Type Fonts by default?
...
/////////////////////////////////////////////
    ...
    protected function GetDefaultTTFont()
    {
        if (!isset($this->default_ttfont)) {
            ...
            $fonts = array(DIR_FS_CATALOG . DIR_WS_INCLUDES . 'fonts/unifont.ttf');
    ...
    protected function SetDefaultFonts()
    {
        // TTF:
        if ($this->use_ttf) {
            return $this->SetFont('generic', '', 10)
                && $this->SetFont('title', '', 12)
                && $this->SetFont('legend', '', 9)
                && $this->SetFont('x_label', '', 8)
                && $this->SetFont('y_label', '', 8)
    ...
    function SetFont($which_elem, $which_font, $which_size = 12, $line_spacing = NULL)
    {
        ...
        return $this->SetFontGD($which_elem, $which_size, $line_spacing);
    }
    ...
    protected function ProcessText($draw_it, $font, $angle, $x, $y, $color, $text, $halign, $valign)
    {
		...
		$text = preg_replace('/%u([0-9A-F]+)/', '&#x$1;', $text);
...
/////////////////////////////////////////////
    ...
    {
        return $this->SetFont('title', 0, $which_size);
    }
    ...
    {
        $this->SetFont('x_label', 0, $which_size);
        $this->SetFont('y_label', 0, $which_size);
    }
    ...
    {
        return $this->SetFont('generic', 0, $which_size);
    }
    ...
    {
        return $this->SetFont('x_title', 0, $which_size);
    }
    ...
    {
        return $this->SetFont('y_title', 0, $which_size);
    }
