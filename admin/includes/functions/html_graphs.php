<?php
/* --------------------------------------------------------------
   $Id: html_graphs.php 950 2014-03-13 16:45:21Z mz $   
...
defined( '_VALID_XTC' ) or die( 'Direct Access to this location is not allowed.' );
  ...
  function xtc_banner_graph_infoBox($banner_id, $days) {
    ...
    $dbars = array();
    for ($i = 0, $n = sizeof($values); $i < $n; $i++) {
      $bars[$i] = DIR_WS_ADMIN . 'html/assets/images/legacy/graph_hbar_blue.gif';
      $dbars[$i] = DIR_WS_ADMIN . 'html/assets/images/legacy/graph_hbar_red.gif';
    }
  ...
  function xtc_banner_graph_monthly($banner_id) {
    ...
    for ($i=1; $i<13; $i++) {
      $names[] = utf8_encode_wrapper(strftime('%b', mktime(0,0,0,$i)));
      $values[] = '0';
      $dvalues[] = '0';
    }
