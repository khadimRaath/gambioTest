<?php
/* --------------------------------------------------------------
   gm_pdf_order_info.php 2015-09-07 gm
   Gambio GmbH
   http://www.gambio.de
	...
	<!-- <table border="0" width="100%" cellspacing="0" cellpadding="2" class="normalize-table">
		<tr>
			<td valign="top" align="left" class="main">
				<h2><?php echo MENU_TITLE_ORDER_INFO; ?></h2>
			</td>
		</tr>
	</table> -->
			...
			<?php foreach($gm_values as $key => $value) {?>
				...
				<tr class="dataTableRow">
					...
					<td valign="top" align="left" class="main dataTableContent" style="width: 50%;">
						<textarea onClick="gm_fadeout_boxes('gm_status')" style="width:400px;" id=<?php echo '"' . $key . '"'; if($key == 'GM_PDF_INFO_TEXT_PACKINGSLIP' || $key == 'GM_PDF_INFO_TEXT_INVOICE') { echo 'rows="10"'; } else { echo 'rows="1"'; } ?>><?php echo $value; ?></textarea>
					</td>
				</tr>
			<?php } ?>
		</table>
