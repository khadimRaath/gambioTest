...
var img_close;
img_del=new Image();
img_del.src="./html/assets/images/legacy/cal_del_small.gif";
img_close=new Image();
img_close.src="./html/assets/images/legacy/cal_close_small.gif";
...
img_Date_UP.src="./html/assets/images/legacy/cal_date_up.gif";

img_Date_OVER=new Image();
img_Date_OVER.src="./html/assets/images/legacy/cal_date_over.gif";

img_Date_DOWN=new Image();
img_Date_DOWN.src="./html/assets/images/legacy/cal_date_down.gif";
...
function Calendar(whatMonth,whatYear) {
    ...
    output += '<td class="cal-HeadCell" align="center" width="100%"><a href="javascript:clearDay();"><img name="calbtn1" src="./html/assets/images/legacy/cal_del_small.gif" border="0" width="12" height="10"></a>&nbsp;&nbsp;<a href="javascript:scrollMonth(-1);" class="cal-DayLink">&lt;</a>&nbsp;<SELECT class="cal-TextBox" NAME="cboMonth" onChange="changeMonth();">';
    ...
    output += '<\/SELECT>&nbsp;<a href="javascript:scrollMonth(1);" class="cal-DayLink">&gt;</a>&nbsp;&nbsp;<a href="javascript:hideCalendar();"><img name="calbtn2" src="./html/assets/images/legacy/cal_close_small.gif" border="0" width="12" height="10"></a><\/td><\/tr><tr><td width="100%" align="center">';
